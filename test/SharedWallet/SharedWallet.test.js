    ...
    describe('Main functionality', function () {
        ...
        describe('Adding members', function () {
            it('should not add member who already exists', async function () {
                try {
                    await this.wallet.createRequest(0, 0, creator, { from: creator });
                    expect.fail();
                } catch (err) { }
            });
        ...
        describe('Removing members', function () {
            it('should not run if non-member address is passed', async function () {
                try {
                    await this.wallet.createRequest(1, 0, nonMember, { from: creator });
                    expect.fail();
                } catch (err) { }
            });
        ...
        describe('Withdraw', function () {
            ...
            it('should transfer to request author', async function () {
                ...
                await this.wallet.createRequest(2, web3.utils.toWei('1', 'ether'), nullAddress, { from: testAddr });
